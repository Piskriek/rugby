...
/* 14 players in the Chaos Scrimmage (7v7); each needs one distinct bit, and
 * bit 4 << 13 = 0x2000 still fits the 16-bit InteractionGroups mask. */
const MAX_PLAYER_BITS = 14;
