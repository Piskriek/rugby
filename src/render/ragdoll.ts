...
const JOINTS: JointDef[] = [
  { names: ['pelvis', 'Hips', 'mixamorigHips'], r: 0.135, m: 13, drives: ['spine_01', 'thigh_l', 'thigh_r'] },
  { names: ['spine_01', 'Spine', 'mixamorigSpine'], r: 0.13, m: 6, drives: ['spine_02'] },
  { names: ['spine_02', 'Spine1', 'mixamorigSpine1'], r: 0.13, m: 6, drives: ['spine_03'] },
  { names: ['spine_03', 'Spine2', 'mixamorigSpine2'], r: 0.15, m: 7, drives: ['neck_01', 'clavicle_l', 'clavicle_r'] },
  { names: ['neck_01', 'Neck', 'mixamorigNeck'], r: 0.09, m: 1.6, drives: ['head'] },
  { names: ['head', 'Head', 'mixamorigHead'], r: 0.115, m: 5, drives: [] },
  { names: ['clavicle_l', 'LeftShoulder', 'mixamorigLeftShoulder'], r: 0.075, m: 1.7, drives: ['upperarm_l'], rigid: 'clavicle_r' },
  { names: ['upperarm_l', 'LeftArm', 'mixamorigLeftArm'], r: 0.07, m: 1.9, drives: ['lowerarm_l'] },
  { names: ['lowerarm_l', 'LeftForeArm', 'mixamorigLeftForeArm'], r: 0.058, m: 1.25, drives: ['hand_l'] },
  { names: ['hand_l', 'LeftHand', 'mixamorigLeftHand'], r: 0.05, m: 0.5, drives: [] },
  { names: ['clavicle_r', 'RightShoulder', 'mixamorigRightShoulder'], r: 0.075, m: 1.7, drives: ['upperarm_r'] },
  { names: ['upperarm_r', 'RightArm', 'mixamorigRightArm'], r: 0.07, m: 1.9, drives: ['lowerarm_r'] },
  { names: ['lowerarm_r', 'RightForeArm', 'mixamorigRightForeArm'], r: 0.058, m: 1.25, drives: ['hand_r'] },
  { names: ['hand_r', 'RightHand', 'mixamorigRightHand'], r: 0.05, m: 0.5, drives: [] },
  { names: ['thigh_l', 'LeftUpLeg', 'mixamorigLeftUpLeg'], r: 0.09, m: 9, drives: ['calf_l'] },
  { names: ['calf_l', 'LeftLeg', 'mixamorigLeftLeg'], r: 0.07, m: 4.4, drives: ['foot_l'] },
  { names: ['foot_l', 'LeftFoot', 'mixamorigLeftFoot'], r: 0.05, m: 1.4, drives: [] },
  { names: ['thigh_r', 'RightUpLeg', 'mixamorigRightUpLeg'], r: 0.09, m: 9, drives: ['calf_r'] },
  { names: ['calf_r', 'RightLeg', 'mixamorigRightLeg'], r: 0.07, m: 4.4, drives: ['foot_r'] },
  { names: ['foot_r', 'RightFoot', 'mixamorigRightFoot'], r: 0.05, m: 1.4, drives: [] },
];
